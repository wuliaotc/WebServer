...
namespace reactor {
    namespace detail {
        ...
        char require_32_bit_integer_at_least[
                sizeof(int) >= sizeof(int32_t) ? 1 : -1];
...
// http://blog.csdn.net/Solstice
        ...
        int getJulianDayNumber(int year, int month, int day) {
            ...
            int y = year + 4800 - a;
            int m = month + 12 * a - 3;
            return day + (153 * m + 2) / 5 + y * 365 + y / 4 - y / 100 +
                   y / 400 - 32045;
        }
    ...
    const int Date::kJulianDayOf1970_01_01 = detail::getJulianDayNumber(1970, 1,
                                                                        1);
}  // namespace reactor
