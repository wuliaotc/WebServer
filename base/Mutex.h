...
// };
    ...
    public:
        ...
        bool isLockedByThisThread() const {
            return holder_ == reactor::CurrentThread::tid();
        }
    ...
    private:
        ...
        //用于简化condition 对UnassignGuard的调用
        ...
        //用于指明锁的状态和持有锁的线程
        void assignHolder() { holder_ = reactor::CurrentThread::tid(); }
...
// }
    ...
    public:
        explicit MutexLockGuard(MutexLock &mutex) ACQUIRE(mutex): mutex_(
                mutex) {
            mutex_.lock();
        }
